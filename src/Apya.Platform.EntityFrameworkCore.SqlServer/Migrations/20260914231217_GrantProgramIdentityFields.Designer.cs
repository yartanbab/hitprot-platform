...
namespace Apya.Platform.Migrations
{
    ...
    [Migration("20260914231217_GrantProgramIdentityFields")]
    partial class GrantProgramIdentityFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Apya.Platform.Agreements.ServiceAgreement", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<decimal>("SuccessFeePercent")
                    ...
                    b.ToTable("AppServiceAgreements", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Billing.SubscriptionInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSubscriptionInvoices", (string)null);
                });

            modelBuilder.Entity("Apya.Platform.Billing.SubscriptionPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("DeclaredByTenant")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Apya.Platform.CashMovements.CashMovement", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "MovementDate"), new[] { "CashAccountId", "Direction", "Amount" });

                    b.HasIndex("TenantId", "CashAccountId", "MovementDate");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "CashAccountId", "MovementDate"), new[] { "Direction", "Amount", "IsDeleted" });
            ...
            modelBuilder.Entity("Apya.Platform.Expenses.Expense", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "ExpenseDate"), new[] { "ProjectId", "Amount", "IsDeleted" });
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantAppealItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InstitutionText")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
                    ...
                    b.Property<string>("OpinionByName")
                        .HasMaxLength(96)
                        .HasColumnType("nvarchar(96)");

                    b.Property<string>("OpinionDetail")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("OpinionSummary")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.ToTable("AppGrantAppealItems", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantApplication", b =>
                {
                    ...
                    b.Property<DateTime?>("PackageCreatedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("PackageStoredFileName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantApplicationActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppGrantApplicationActivities", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantApplicationDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GrantApplicationId", "RequirementId");

                    b.ToTable("AppGrantApplicationDocuments", (string)null);
                });

            modelBuilder.Entity("Apya.Platform.Grants.GrantApplicationDocumentVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppGrantApplicationDocumentVersions", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantConsultingLog", b =>
                {
                    ...
                    b.HasIndex("GrantApplicationId", "WorkDate");

                    b.ToTable("AppGrantConsultingLogs", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantDecision", b =>
                {
                    ...
                    b.Property<bool?>("AppealAccepted")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantInterest", b =>
                {
                    ...
                    b.HasIndex("TenantId", "GrantCallId", "Status");

                    b.ToTable("AppGrantInterests", (string)null);
                });

            modelBuilder.Entity("Apya.Platform.Grants.GrantLead", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("CompanyAgeYears")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("EstimatedSupport")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<DateTime?>("PreferredMeetingAt")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("IpAddress", "CreationTime");

                    b.HasIndex("Status", "HeatScore");

                    b.ToTable("AppGrantLeads", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantMeetingProposal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("ConfirmedSlot")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<Guid>("GrantInterestId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("Slot1")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("Slot2")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("Slot3")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("GrantInterestId", "Status");

                    b.ToTable("AppGrantMeetingProposals", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantNotificationLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("DayMark")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Trigger", "EntityId", "DayMark")
                        .IsUnique();

                    b.ToTable("AppGrantNotificationLogs", (string)null);
                });

            modelBuilder.Entity("Apya.Platform.Grants.GrantNotificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantReport", b =>
                {
                    ...
                    b.HasIndex("GrantApplicationId", "Order");

                    b.ToTable("AppGrantReports", (string)null);
                });

            modelBuilder.Entity("Apya.Platform.Grants.GrantReportSection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ReportId", "Order");

                    b.ToTable("AppGrantReportSections", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Incomes.IncomeEntry", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "IncomeDate"), new[] { "ProjectId", "Amount", "IsDeleted" });
            ...
            modelBuilder.Entity("Apya.Platform.Invoices.Invoice", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "Status"), new[] { "TotalAmount", "ProjectId", "IsDeleted" });
            ...
            modelBuilder.Entity("Apya.Platform.RegistrationRequests.RegistrationRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("InviteIssuedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("InviteUsedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("AppRegistrationRequests", (string)null);
                });

            modelBuilder.Entity("Apya.Platform.ReleaseNotes.ReleaseNotePublication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Version", "ItemKey")
                        .IsUnique();

                    b.ToTable("AppReleaseNotePublications", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Tasks.TaskDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTaskDocuments", (string)null);
                });
            ...
            modelBuilder.Entity("Apya.Platform.Billing.SubscriptionPayment", b =>
                {
                    b.HasOne("Apya.Platform.Billing.SubscriptionInvoice", null)
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantAppealItem", b =>
                {
                    b.HasOne("Apya.Platform.Grants.GrantDecision", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantApplicationDocumentVersion", b =>
                {
                    b.HasOne("Apya.Platform.Grants.GrantApplicationDocument", null)
                        .WithMany("Versions")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantMeetingProposal", b =>
                {
                    b.HasOne("Apya.Platform.Grants.GrantInterest", null)
                        .WithMany()
                        .HasForeignKey("GrantInterestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Apya.Platform.Grants.GrantReportSection", b =>
                {
                    b.HasOne("Apya.Platform.Grants.GrantReport", null)
                        .WithMany("Sections")
