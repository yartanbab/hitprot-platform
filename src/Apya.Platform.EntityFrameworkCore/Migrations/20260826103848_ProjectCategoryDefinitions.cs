...
{
    /// <summary>
    /// Proje kategorisi sabit enum'dan tanım tablosuna taşınır.
    ///
    ...
    ///
    /// Sistem satırları burada INSERT edilir, ayrı bir seed contributor'da DEĞİL:
    /// DbMigrator tohumlayıcıları yalnız host bağlamında tek kez çalıştırır, bu satırlar
    /// ise şemanın FK'si için migration'ın kendi içinde var olmak zorundadır.
    /// </summary>
