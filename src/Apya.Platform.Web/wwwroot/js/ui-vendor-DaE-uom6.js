...
}, Ur = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, Hr = /^\((?:(\w[\w-]*):)?(.+)\)$/i, hi = /^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/, vi = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, gi = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, bi = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, yi = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, wi = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, we = (e) => hi.test(e), N = (e) => !!e && !Number.isNaN(Number(e)), te = (e) => !!e && Number.isInteger(Number(e)), Xt = (e) => e.endsWith("%") && N(e.slice(0, -1)), ue = (e) => vi.test(e), Gr = () => !0, xi = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  gi.test(e) && !bi.test(e)
), _n = () => !1, Ei = (e) => yi.test(e), Ci = (e) => wi.test(e), Si = (e) => !P(e) && !R(e), Pi = (e) => e.startsWith("@container") && (e[10] === "/" && e[11] !== void 0 || e[11] === "s" && e[16] !== void 0 && e.startsWith("-size/", 10) || e[11] === "n" && e[18] !== void 0 && e.startsWith("-normal/", 10)), Ri = (e) => Pe(e, Xr, _n), P = (e) => Ur.test(e), $e = (e) => Pe(e, Zr, xi), rr = (e) => Pe(e, Ti, N), Oi = (e) => Pe(e, Qr, Gr), Ai = (e) => Pe(e, qr, _n), or = (e) => Pe(e, Yr, _n), ki = (e) => Pe(e, Kr, Ci), ht = (e) => Pe(e, Jr, Ei), R = (e) => Hr.test(e), ot = (e) => Ie(e, Zr), _i = (e) => Ie(e, qr), sr = (e) => Ie(e, Yr), $i = (e) => Ie(e, Xr), Di = (e) => Ie(e, Kr), vt = (e) => Ie(e, Jr, !0), Ni = (e) => Ie(e, Qr, !0), Pe = (e, t, n) => {
  const r = Ur.exec(e);
  return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, Ie = (e, t, n = !1) => {
  const r = Hr.exec(e);
  return r ? r[1] ? t(r[1]) : n : !1;
}, Yr = (e) => e === "position" || e === "percentage", Kr = (e) => e === "image" || e === "url", Xr = (e) => e === "length" || e === "size" || e === "bg-size", Zr = (e) => e === "length", Ti = (e) => e === "number", qr = (e) => e === "family-name", Qr = (e) => e === "number" || e === "weight", Jr = (e) => e === "shadow", Li = () => {
...
}, Rf = /* @__PURE__ */ pi(Li), Of = /* @__PURE__ */ Us(Hs);
function ir(e, t) {
  if (typeof e == "function")
    return e(t);
  e != null && (e.current = t);
  ...
  const t = c.forwardRef((n, r) => {
    ...
    ar(o) && typeof gt == "function" && (o = gt(o._payload)), c.Children.forEach(o, (p) => {
      ...
      if (zi(p)) {
        ...
        ar(m) && typeof gt == "function" && (m = gt(m._payload)), i = Fi(v, m), l.push((h = i == null ? void 0 : i.props) == null ? void 0 : h.children);
      } else
        l.push(p);
...
function zi(e) {
  return c.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === eo;
}
...
const cr = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, lr = un, _f = (e, t) => (n) => {
  var r;
...
var na = "DismissableLayer", dn = "dismissableLayer.update", ra = "dismissableLayer.pointerDownOutside", oa = "dismissableLayer.focusOutside", ur, Dn = c.createContext({
...
function ua(e, t = globalThis == null ? void 0 : globalThis.document) {
  ...
  return c.useEffect(() => {
    const o = (s) => {
      s.target && !r.current && no(oa, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
var qt = "focusScope.autoFocusOnMount", Qt = "focusScope.autoFocusOnUnmount", dr = { bubbles: !1, cancelable: !0 }, fa = "FocusScope", ro = c.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  c.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(m)) {
        ...
        a.addEventListener(qt, f), a.dispatchEvent(b), b.defaultPrevented || (da(ga(oo(a)), { select: !0 }), document.activeElement === m && xe(a));
      }
      return () => {
...
function pa(e) {
  const t = oo(e), n = pr(t, e), r = pr(t.reverse(), e);
  return [n, r];
}
function oo(e) {
...
var ba = "Portal", so = c.forwardRef((e, t) => {
  var a;
...
var Aa = typeof window < "u" ? c.useLayoutEffect : c.useEffect, br = /* @__PURE__ */ new WeakMap();
function ka(e, t) {
...
var co = Da(), en = function() {
}, Ft = c.forwardRef(function(e, t) {
  var n = c.useRef(null), r = c.useState({
    onScrollCapture: en,
    onWheelCapture: en,
    onTouchMoveCapture: en
  }), o = r[0], s = r[1], i = e.forwardProps, a = e.children, l = e.className, f = e.removeScrollBar, d = e.enabled, u = e.shards, p = e.sideCar, h = e.noRelative, v = e.noIsolation, m = e.inert, g = e.allowPinchZoom, b = e.as, w = b === void 0 ? "div" : b, y = e.gapMode, x = io(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), C = p, S = ka([n, t]), k = oe(oe({}, x), o);
  return c.createElement(
    c.Fragment,
    null,
    d && c.createElement(C, { sideCar: co, removeScrollBar: f, shards: u, noRelative: h, noIsolation: v, inert: m, setCallbacks: s, allowPinchZoom: !!g, lockRef: n, gapMode: y }),
...
}, Ba = lo(), He = "data-scroll-locked", Ua = function(e, t, n, r) {
...
var ze = pn ? { passive: !1 } : !1, Ya = function(e) {
  ...
  do {
    if (!a)
      break;
    var h = po(e, a), v = h[0], m = h[1], g = h[2], b = m - g - s * v;
    (v || b) && fo(e, a) && (u += b, p += v);
    var w = a.parentNode;
...
function rc(e) {
  var t = c.useRef([]), n = c.useRef([0, 0]), r = c.useRef(), o = c.useState(nc++)[0], s = c.useState(lo)[0], i = c.useRef(e);
  c.useEffect(function() {
    i.current = e;
...
}, Be = /* @__PURE__ */ new WeakMap(), xt = /* @__PURE__ */ new WeakMap(), Et = {}, nn = 0, mo = function(e) {
...
}, jt = "Dialog", [vo] = Gi(jt), [lc, q] = vo(jt), uc = (e) => {
  const {
    __scopeDialog: t,
    children: n,
    open: r,
...
uc.displayName = jt;
var go = "DialogTrigger", fc = c.forwardRef(
  (e, t) => {
...
fc.displayName = go;
var Tn = "DialogPortal", [dc, bo] = vo(Tn, {
  forceMount: void 0
}), pc = (e) => {
  const { __scopeDialog: t, forceMount: n, children: r, container: o } = e, s = q(Tn, t);
  return /* @__PURE__ */ A.jsx(dc, { scope: t, forceMount: n, children: c.Children.map(r, (i) => /* @__PURE__ */ A.jsx(Mt, { present: n || s.open, children: /* @__PURE__ */ A.jsx(so, { asChild: !0, container: o, children: i }) })) });
};
pc.displayName = Tn;
var Dt = "DialogOverlay", mc = c.forwardRef(
  (e, t) => {
    const n = bo(Dt, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, s = q(Dt, e.__scopeDialog);
...
var hc = /* @__PURE__ */ $n("DialogOverlay.RemoveScroll"), vc = c.forwardRef(
  ...
  (e, t) => {
    const n = bo(Ye, e.__scopeDialog), { forceMount: r = n.forceMount, ...o } = e, s = q(Ye, e.__scopeDialog);
...
), wo = "DialogTitle", wc = c.forwardRef(
  (e, t) => {
...
wc.displayName = wo;
var xo = "DialogDescription", xc = c.forwardRef(
  (e, t) => {
...
xc.displayName = xo;
var Eo = "DialogClose", Ec = c.forwardRef(
  (e, t) => {
...
var Cc = Object.defineProperty, Ze = (e, t) => Cc(e, "name", { value: t, configurable: !0 }), Co = !!(typeof window < "u" && window.document && window.document.createElement);
...
function Mn(e) {
  const t = c.forwardRef((n, r) => {
    ...
    const u = _o(s, i.props ?? {});
    return i.type !== c.Fragment && (u.ref = r ? d : f), c.cloneElement(i, u);
  });
  return t.displayName = `${e}.Slot`, t;
}
Q(Mn, "createSlot");
var ko = Symbol.for("radix.slottable");
// @__NO_SIDE_EFFECTS__
function kc(e) {
  const t = /* @__PURE__ */ Q((n) => "child" in n ? n.children(n.child) : n.children, "Slottable");
  return t.displayName = `${e}.Slottable`, t.__radixId = ko, t;
}
...
Q($o, "getElementRef");
function Do(e) {
  return c.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === ko;
}
Q(Do, "isSlottable");
var $c = Symbol.for("react.lazy");
function vn(e) {
  return e != null && typeof e == "object" && "$$typeof" in e && e.$$typeof === $c && "_payload" in e && No(e._payload);
}
...
Lc(To, "dispatchDiscreteCustomEvent");
...
var jc = Object.defineProperty, U = (e, t) => jc(e, "name", { value: t, configurable: !0 }), gn = "dismissableLayer.update", Wc = "dismissableLayer.pointerDownOutside", zc = "dismissableLayer.focusOutside", Cr, Lo = c.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set(),
  // Outside elements that belong to a layer's own dismiss affordance (eg, a
  ...
  /* @__PURE__ */ U(function(t, n) {
    const {
      ...
      onDismiss: f,
      ...d
    } = t, u = c.useContext(Lo), [p, h] = c.useState(null), v = (p == null ? void 0 : p.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, m] = c.useState({}), g = qe(n, h), b = Array.from(u.layers), [w] = [
      ...u.layersWithOutsidePointerEventsDisabled
    ].slice(-1), y = w ? b.indexOf(w) : -1, x = p ? b.indexOf(p) : -1, C = u.layersWithOutsidePointerEventsDisabled.size > 0, S = x >= y, k = c.useRef(!1), E = Io(
      ($) => {
...
function Bc() {
  const e = c.useContext(Lo), [t, n] = c.useState(null);
  return c.useEffect(() => {
    if (t)
      return e.dismissableSurfaces.add(t), () => {
        e.dismissableSurfaces.delete(t);
...
var Yc = Object.defineProperty, Y = (e, t) => Yc(e, "name", { value: t, configurable: !0 }), rn = "focusScope.autoFocusOnMount", on = "focusScope.autoFocusOnUnmount", Sr = { bubbles: !1, cancelable: !0 }, Kc = /* @__PURE__ */ c.forwardRef(
  /* @__PURE__ */ Y(function(t, n) {
    ...
    c.useEffect(() => {
      ...
      if (l) {
        ...
        if (!l.contains(g)) {
          ...
          l.addEventListener(rn, d), l.dispatchEvent(w), w.defaultPrevented || (Fo(Bo(zn(l)), { select: !0 }), document.activeElement === g && fe(l));
        }
        return () => {
    ...
    const m = c.useCallback(
      (g) => {
        ...
        if (b && w) {
          const y = g.currentTarget, [x, C] = jo(y);
...
function wn(e, t) {
  const n = typeof t.checkVisibility == "function" && t.checkVisibility({ checkVisibilityCSS: !0 });
  for (const r of e)
    if (!(n ? !r.checkVisibility({ checkVisibilityCSS: !0 }) : Wo(r, { upTo: t })))
      return r;
}
Y(wn, "findVisible");
...
const Rr = ["left", "right"], Or = ["right", "left"], rl = ["top", "bottom"], ol = ["bottom", "top"];
function sl(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
...
async function cl(e, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: h = 0
  } = ve(t, e), v = Go(h), g = a[p ? u === "floating" ? "reference" : "floating" : u], b = Lt(await s.getClippingRect({
...
const ll = 50, ul = async (e, t, n) => {
  ...
  async fn(t) {
    ...
    const E = x / 2 - C / 2, D = k / 2 - m[v] / 2 - 1, L = Ce(u[b], D), _ = Ce(u[w], D), $ = k - m[v] - _, F = k / 2 - m[v] / 2 + E, M = Ho(L, F, $), z = !l.arrow && Qe(o) != null && F !== M && s.reference[v] / 2 - (F < L ? L : _) - m[v] / 2 < 0, I = z ? F < L ? F - L : F - $ : 0;
    return {
      [h]: p[h] + I,
      data: {
        [h]: M,
...
}, Yo = /* @__PURE__ */ new Set(["left", "top"]);
async function ml(e, t) {
  const {
    placement: n,
    platform: r,
    elements: o
  } = e, s = await (r.isRTL == null ? void 0 : r.isRTL(o.floating)), i = Se(n), a = Qe(n), l = se(n) === "y", f = Yo.has(i) ? -1 : 1, d = s && l ? -1 : 1, u = ve(t, e);
  let {
    mainAxis: p,
    crossAxis: h,
    alignmentAxis: v
...
const hl = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      let v = d[h], m = d[p];
      const g = (w, y) => Ho(y + u[w === "y" ? "top" : "left"], y, y - u[w === "y" ? "bottom" : "right"]);
      i && (v = g(h, v)), a && (m = g(p, m));
      const b = l.fn({
        ...t,
        [h]: v,
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (u) {
        var y, x;
        const C = v === "y" ? "width" : "height", S = Yo.has(Se(i)), k = a.reference[h] - a.floating[C] + (S && ((y = l.offset) == null ? void 0 : y[h]) || 0) + (S ? 0 : w.crossAxis), E = a.reference[h] + a.reference[C] + (S ? 0 : ((x = l.offset) == null ? void 0 : x[h]) || 0) - (S ? w.crossAxis : 0);
        g < k ? g = k : g > E && (g = E);
      }
      return {
        [v]: m,
...
function Xo(e) {
  const t = Ne(e);
  return ct(t) ? (e.ownerDocument || e).body : Re(t) && zt(t) ? t : Xo(t);
}
function lt(e, t, n) {
  var r;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const o = Xo(e), s = o === ((r = e.ownerDocument) == null ? void 0 : r.body), i = K(o);
  if (s) {
    const a = Cn(i);
...
function Dl(e) {
  ...
  const i = [...n === "clippingAncestors" ? Vt(t) ? [] : $l(t, this._c) : [].concat(n), r], a = Dr(t, i[0], o);
...
function Fl(e, t, n) {
  ...
  function a(d, u) {
    ...
    function E(D) {
      ...
      if (!es(p, e.getBoundingClientRect()))
        return a();
      if (L !== u) {
        if (!k)
          return a();
...
function jl(e, t, n, r) {
  ...
  function g() {
    const b = Te(e);
    m && !es(m, b) && n(), m = b, v = requestAnimationFrame(g);
  }
  return n(), () => {
    var b;
    d.forEach((w) => {
...
const Wl = hl, zl = vl, Vl = dl, Bl = bl, Ul = pl, Tr = fl, Hl = gl, Gl = (e, t, n) => {
...
Kn(ns, "composeRefs");
function rs(...e) {
  return c.useCallback(ns(...e), e);
}
Kn(rs, "useComposedRefs");
...
function os(e) {
  const t = c.forwardRef((n, r) => {
    ...
    const f = i ? as(i) : void 0, d = rs(r, f);
    if (!i) {
      if (o || o === 0)
        throw new Error(
          a ? uu(e) : lu(e)
    ...
    const u = is(s, i.props ?? {});
    return i.type !== c.Fragment && (u.ref = r ? d : f), c.cloneElement(i, u);
  });
  return t.displayName = `${e}.Slot`, t;
}
J(os, "createSlot");
var ss = Symbol.for("radix.slottable");
// @__NO_SIDE_EFFECTS__
function iu(e) {
...
J(as, "getElementRef");
function cs(e) {
  return c.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === ss;
}
J(cs, "isSlottable");
var cu = Symbol.for("react.lazy");
function Pn(e) {
  return e != null && typeof e == "object" && "$$typeof" in e && e.$$typeof === cu && "_payload" in e && ls(e._payload);
}
...
var lu = /* @__PURE__ */ J((e) => `${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`, "createSlotError"), uu = /* @__PURE__ */ J((e) => `${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`, "createSlottableError"), Rt = ce[" use ".trim().toString()], fu = Object.defineProperty, du = (e, t) => fu(e, "name", { value: t, configurable: !0 }), pu = [
  ...
  const n = /* @__PURE__ */ os(`Primitive.${t}`), r = c.forwardRef((o, s) => {
    const { asChild: i, ...a } = o, l = i ? n : t;
    return typeof window < "u" && (window[Symbol.for("radix-ui")] = !0), /* @__PURE__ */ A.jsx(l, { ...a, ref: s });
  });
  return r.displayName = `Primitive.${t}`, { ...e, [t]: r };
...
function ps(e) {
  const t = c.forwardRef((n, r) => {
    ...
    const f = i ? vs(i) : void 0, d = Ht(r, f);
    if (!i) {
      if (o || o === 0)
        throw new Error(
          a ? Au(e) : Ou(e)
    ...
    const u = hs(s, i.props ?? {});
    return i.type !== c.Fragment && (u.ref = r ? d : f), c.cloneElement(i, u);
  });
  return t.displayName = `${e}.Slot`, t;
}
ee(ps, "createSlot");
var ms = Symbol.for("radix.slottable");
// @__NO_SIDE_EFFECTS__
function Su(e) {
...
function On(e) {
  return e != null && typeof e == "object" && "$$typeof" in e && e.$$typeof === Ru && "_payload" in e && bs(e._payload);
}
...
var Ou = /* @__PURE__ */ ee((e) => `${e} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`, "createSlotError"), Au = /* @__PURE__ */ ee((e) => `${e} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`, "createSlottableError"), Ot = ce[" use ".trim().toString()], ku = Object.defineProperty, _u = (e, t) => ku(e, "name", { value: t, configurable: !0 }), $u = [
  ...
  const n = /* @__PURE__ */ ps(`Primitive.${t}`), r = c.forwardRef((o, s) => {
    const { asChild: i, ...a } = o, l = i ? n : t;
    return typeof window < "u" && (window[Symbol.for("radix-ui")] = !0), /* @__PURE__ */ A.jsx(l, { ...a, ref: s });
  });
  return r.displayName = `Primitive.${t}`, { ...e, [t]: r };
...
Mu(xs, "useSize");
var Fu = Object.defineProperty, he = (e, t) => Fu(e, "name", { value: t, configurable: !0 }), Es = "Popper", [Cs, Ss] = /* @__PURE__ */ fs(Es), [ju, Ps] = Cs(Es), Wu = /* @__PURE__ */ he((e) => {
  ...
  /* @__PURE__ */ he(function(t, n) {
    const { __scopePopper: r, virtualRef: o, ...s } = t, i = Ps(zu, r), a = c.useRef(null), l = i.onAnchorChange, f = c.useCallback(
      (m) => {
        a.current = m, m && l(m);
      },
      [l]
...
), Rs = "PopperContent", [Bu, Uu] = Cs(Rs), Hu = /* @__PURE__ */ c.forwardRef(
  /* @__PURE__ */ he(function(t, n) {
    ...
    const {
      ...
      onPlaced: m,
      ...g
    } = t, b = Ps(Rs, r), [w, y] = c.useState(null), x = Ht(n, y), [C, S] = c.useState(null), k = xs(C), E = (k == null ? void 0 : k.width) ?? 0, D = (k == null ? void 0 : k.height) ?? 0, L = o + (i !== "center" ? "-" + i : ""), _ = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, $ = Array.isArray(d) ? d : [d], F = $.length > 0, M = {
      padding: _,
      boundary: $.filter(Os),
      ...
      middleware: [
        ...
        tu({
          ...M,
          apply: /* @__PURE__ */ he(({ elements: Kt, rects: Jn, availableWidth: Ws, availableHeight: zs }) => {
            const { width: Vs, height: Bs } = Jn.reference, mt = Kt.floating.style;
            mt.setProperty("--radix-popper-available-width", `${Ws}px`), mt.setProperty("--radix-popper-available-height", `${zs}px`), mt.setProperty("--radix-popper-anchor-width", `${Vs}px`), mt.setProperty("--radix-popper-anchor-height", `${Bs}px`);
          }, "apply")
        }),
...
ge(As, "useStateMachine");
var ks = /* @__PURE__ */ ge((e) => {
  const { present: t, children: n } = e, r = _s(t), o = typeof n == "function" ? n({ present: r.isPresent }) : c.Children.only(n), s = $s(r.ref, Ds(o));
  return typeof n == "function" || r.isPresent ? c.cloneElement(o, { ref: s }) : null;
}, "Presence");
function _s(e) {
  const [t, n] = c.useState(), r = c.useRef(null), o = c.useRef(e), s = c.useRef("none"), i = c.useRef(void 0), a = e ? "mounted" : "unmounted", [l, f] = As(a, {
    mounted: {
      UNMOUNT: "unmounted",
      ANIMATION_OUT: "unmountSuspended"
    },
...
ge(Ds, "getElementRef");
var of = Object.defineProperty, sf = (e, t) => of(e, "name", { value: t, configurable: !0 }), Ir = ce[" useEffectEvent ".trim().toString()], Mr = ce[" useInsertionEffect ".trim().toString()];
function Ns(e) {
...
function lf(e, t, n, r) {
  const { prop: o, defaultProp: s, onChange: i, caller: a } = t, l = o !== void 0, f = Ns(i), d = [{ ...n, state: s }];
  r && d.push(r);
...
var uf = Object.defineProperty, le = (e, t) => uf(e, "name", { value: t, configurable: !0 }), Zn = "Popover", [Ms, $f] = /* @__PURE__ */ Oo(Zn, [
  Ss
]), Yt = Ss(), [ff, Fe] = Ms(Zn), df = /* @__PURE__ */ le((e) => {
  const {
    __scopePopover: t,
    children: n,
    open: r,
    ...
    onOpenChange: s,
    modal: i = !1
  } = e, a = Yt(t), l = c.useRef(null), [f, d] = c.useState(!1), [u, p] = Ts({
    prop: r,
    defaultProp: o ?? !1,
    onChange: s,
    caller: Zn
...
), Fs = "PopoverPortal", [hf, vf] = Ms(Fs, {
  forceMount: void 0
}), gf = /* @__PURE__ */ le((e) => {
  const { __scopePopover: t, forceMount: n, children: r, container: o } = e, s = Fe(Fs, t);
  return /* @__PURE__ */ A.jsx(hf, { scope: t, forceMount: n, children: /* @__PURE__ */ A.jsx(ks, { present: n || s.open, children: /* @__PURE__ */ A.jsx(nf, { asChild: !0, container: o, children: r }) }) });
  ...
  /* @__PURE__ */ le(function(t, n) {
    ...
    return /* @__PURE__ */ A.jsx(ks, { present: o || i.open, children: i.modal ? /* @__PURE__ */ A.jsx(wf, { ...s, ref: n }) : /* @__PURE__ */ A.jsx(xf, { ...s, ref: n }) });
  }, "PopoverContent")
