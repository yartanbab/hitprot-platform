# Deploy delta — 2026-09-21 (`d8a01af6` → `ebe3ecd0`)

Canlıda koşan kod, kayıtlara göre **`d8a01af6`** (2026‑09‑14 gece paketi `337eaf55`; en son
2026‑09‑17'de beş dosya blob'uyla ölçüldü). Bu belge onun üzerine gelecek **50 commit**'i anlatır.
